...
function App() {
  return (
    <div className="bg-gray-100 w-screen h-screen flex mobile:flex-col justify-center items-center gap-8 ">
      <div className="w-1/3 mobile:w-fit h-2/3 border border-gray-200 bg-white rounded-lg pt-12 p-8 flex flex-col gap-8 hover:border-purple200 ml-10">
      ...
      <div className="w-1/3 mobile:w-fit h-2/3 rounded-lg border bg-gray900 pt-12 p-8 flex flex-col gap-8 text-white hover:border-purple200 ">
        <div className="flex flex-col gap-8">
          <div>
      ...
      <div className="w-1/3 mobile:w-fit h-2/3 border border-gray-200 bg-white rounded-lg pt-12 p-8 flex flex-col gap-8 hover:border-purple200 ">
        <div className="flex flex-col gap-8">
          <div>
