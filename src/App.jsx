...
function App() {
  return (
    <div className="bg-gray-100 w-screen h-screen flex justify-center items-center gap-8">
      ...
      <div className="w-96 h-2/3 rounded-lg border bg-gray900 pt-12 p-8 flex flex-col gap-8 text-white hover:border-purple200 ">
        <div className="flex flex-col gap-8">
          <div>
